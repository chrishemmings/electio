 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomsDocumentation implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerFormats = [
        ...
        'receivers_tax_code' => null,
        'receivers_vat_number' => null,
    ...
    protected static $attributeMap = [
        ...
        'receivers_tax_code' => 'ReceiversTaxCode',
        'receivers_vat_number' => 'ReceiversVatNumber',
        'invoice_date' => 'InvoiceDate',
        'receivers_shipping_cost' => 'ReceiversShippingCost'
    ];
    ...
    protected static $setters = [
        ...
        'receivers_tax_code' => 'setReceiversTaxCode',
        'receivers_vat_number' => 'setReceiversVatNumber',
        'invoice_date' => 'setInvoiceDate',
        'receivers_shipping_cost' => 'setReceiversShippingCost'
    ];
    ...
    protected static $getters = [
        ...
        'receivers_tax_code' => 'getReceiversTaxCode',
        'receivers_vat_number' => 'getReceiversVatNumber',
        'invoice_date' => 'getInvoiceDate',
        'receivers_shipping_cost' => 'getReceiversShippingCost'
    ];
    ...
    const CATEGORY_TYPE_SALE_OF_GOODS = 'SaleOfGoods';
    const CATEGORY_TYPE_PERSONAL = 'Personal';
    ...
    public function getCategoryTypeAllowableValues()
    {
        return [
            ...
            self::CATEGORY_TYPE_SALE_OF_GOODS,
            self::CATEGORY_TYPE_PERSONAL,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['receivers_tax_code'] = isset($data['receivers_tax_code']) ? $data['receivers_tax_code'] : null;
        $this->container['receivers_vat_number'] = isset($data['receivers_vat_number']) ? $data['receivers_vat_number'] : null;
        $this->container['invoice_date'] = isset($data['invoice_date']) ? $data['invoice_date'] : null;
        $this->container['receivers_shipping_cost'] = isset($data['receivers_shipping_cost']) ? $data['receivers_shipping_cost'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['declaration_date'] === null) {
            $invalidProperties[] = "'declaration_date' can't be null";
        }
     ...
     *
     * @param string $importers_vat_number importers_vat_number
     *
     * @return $this
     */
     ...
     *
     * @param string $shipper_customs_reference shipper_customs_reference
     *
     * @return $this
     */
     ...
     *
     * @param string $importers_tax_code importers_tax_code
     *
     * @return $this
     */
     ...
     *
     * @param string $importers_telephone importers_telephone
     *
     * @return $this
     */
     ...
     * Sets importers_fax
     *
     * @param string $importers_fax importers_fax
     *
     * @return $this
     */
     ...
     * Sets cn23_comments
     *
     * @param string $cn23_comments cn23_comments
     *
     * @return $this
     */
     ...
     *
     * @param string[] $references_of_attached_invoices references_of_attached_invoices
     *
     * @return $this
     */
     ...
     *
     * @param string[] $references_of_attached_licences references_of_attached_licences
     *
     * @return $this
     */
     ...
     *
     * @param string $category_type_explanation category_type_explanation
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $declaration_date declaration_date
     *
     * @return $this
     */
     ...
     *
     * @param string $office_of_posting office_of_posting
     *
     * @return $this
     */
     ...
     *
     * @param string $reason_for_export reason_for_export
     *
     * @return $this
     */
     ...
     * Sets shipping_terms
     *
     * @param string $shipping_terms shipping_terms
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getShippingTermsAllowableValues();
        if (!is_null($shipping_terms) && !in_array($shipping_terms, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'shipping_terms', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param string $shippers_vat_number shippers_vat_number
     *
     * @return $this
     */
     ...
     *
     * @param string $designated_person_responsible designated_person_responsible
     *
     * @return $this
     */
    ...
    /**
     * Gets receivers_tax_code
     *
     * @return string
     */
    public function getReceiversTaxCode()
    {
        return $this->container['receivers_tax_code'];
    }

    /**
     * Sets receivers_tax_code
     *
     * @param string $receivers_tax_code receivers_tax_code
     *
     * @return $this
     */
    public function setReceiversTaxCode($receivers_tax_code)
    {
        $this->container['receivers_tax_code'] = $receivers_tax_code;

        return $this;
    }

    /**
     * Gets receivers_vat_number
     *
     * @return string
     */
    public function getReceiversVatNumber()
    {
        return $this->container['receivers_vat_number'];
    }

    /**
     * Sets receivers_vat_number
     *
     * @param string $receivers_vat_number receivers_vat_number
     *
     * @return $this
     */
    public function setReceiversVatNumber($receivers_vat_number)
    {
        $this->container['receivers_vat_number'] = $receivers_vat_number;
    ...
    /**
     * Gets receivers_shipping_cost
     *
     * @return float
     */
    public function getReceiversShippingCost()
    {
        return $this->container['receivers_shipping_cost'];
    }

    /**
     * Sets receivers_shipping_cost
     *
     * @param float $receivers_shipping_cost receivers_shipping_cost
     *
     * @return $this
     */
    public function setReceiversShippingCost($receivers_shipping_cost)
    {
        $this->container['receivers_shipping_cost'] = $receivers_shipping_cost;
