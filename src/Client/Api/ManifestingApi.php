...
class ManifestingApi
{
     ...
     * @return void
     */
    public function manifest($electio_api_version, $consignment_references = null)
    {
        $this->manifestWithHttpInfo($electio_api_version, $consignment_references);
    }
     ...
     */
    public function manifestWithHttpInfo($electio_api_version, $consignment_references = null)
    {
        $returnType = '';
        $request = $this->manifestRequest($electio_api_version, $consignment_references);
     ...
     */
    public function manifestAsync($electio_api_version, $consignment_references = null)
    {
        return $this->manifestAsyncWithHttpInfo($electio_api_version, $consignment_references)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function manifestAsyncWithHttpInfo($electio_api_version, $consignment_references = null)
    {
        $returnType = '';
        $request = $this->manifestRequest($electio_api_version, $consignment_references);
     ...
     */
    protected function manifestRequest($electio_api_version, $consignment_references = null)
    {
        ...
        if ($electio_api_version === null || (is_array($electio_api_version) && count($electio_api_version) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $electio_api_version when calling manifest'
            );
        }
