...
class CarriersApi
{
     ...
     */
    public function carriers($electio_api_version)
    {
        list($response) = $this->carriersWithHttpInfo($electio_api_version);
        return $response;
    }
     ...
     */
    public function carriersWithHttpInfo($electio_api_version)
    {
        $returnType = '\ChrisHemmings\Electio\Client\Model\Carrier[]';
        $request = $this->carriersRequest($electio_api_version);
     ...
     */
    public function carriersAsync($electio_api_version)
    {
        return $this->carriersAsyncWithHttpInfo($electio_api_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation carriersAsyncWithHttpInfo
     *
     * Get carriers
     *
     * @param  string $electio_api_version Electio API Version (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function carriersAsyncWithHttpInfo($electio_api_version)
    {
        $returnType = '\ChrisHemmings\Electio\Client\Model\Carrier[]';
        $request = $this->carriersRequest($electio_api_version);
    ...
    /**
     * Create request for operation 'carriers'
     *
     * @param  string $electio_api_version Electio API Version (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function carriersRequest($electio_api_version)
    {
        ...
        if ($electio_api_version === null || (is_array($electio_api_version) && count($electio_api_version) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $electio_api_version when calling carriers'
            );
        }
