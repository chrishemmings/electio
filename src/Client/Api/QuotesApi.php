...
class QuotesApi
{
     ...
     * @return \ChrisHemmings\Electio\Client\Model\QuotesResponse
     */
    public function getQuotes($electio_api_version, $allocation = null)
    {
        list($response) = $this->getQuotesWithHttpInfo($electio_api_version, $allocation);
        return $response;
    }
     ...
     * @throws \ChrisHemmings\Electio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ChrisHemmings\Electio\Client\Model\QuotesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getQuotesWithHttpInfo($electio_api_version, $allocation = null)
    {
        $returnType = '\ChrisHemmings\Electio\Client\Model\QuotesResponse';
        $request = $this->getQuotesRequest($electio_api_version, $allocation);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ChrisHemmings\Electio\Client\Model\QuotesResponse',
     ...
     */
    public function getQuotesAsync($electio_api_version, $allocation = null)
    {
        return $this->getQuotesAsyncWithHttpInfo($electio_api_version, $allocation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getQuotesAsyncWithHttpInfo($electio_api_version, $allocation = null)
    {
        $returnType = '\ChrisHemmings\Electio\Client\Model\QuotesResponse';
        $request = $this->getQuotesRequest($electio_api_version, $allocation);
     ...
     */
    protected function getQuotesRequest($electio_api_version, $allocation = null)
    {
        ...
        if ($electio_api_version === null || (is_array($electio_api_version) && count($electio_api_version) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $electio_api_version when calling getQuotes'
            );
        }
